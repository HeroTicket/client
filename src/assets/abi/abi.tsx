...
export const TicketAbi = [
    ...
    {
        "inputs": [],
        "name": "InvalidTicketSaleDuration",
        "type": "error"
    },
    {
        "inputs": [
